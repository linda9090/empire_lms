      ...
      <CardContent className="space-y-4">
        ...
        {newCode && (
          <div className="space-y-4">
            ...
            {showQr && (
              <div className="mt-4 flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 p-6">
                ...
                <div className="text-center">
                  <p className="text-sm font-medium text-slate-700">Scan to join the course</p>
